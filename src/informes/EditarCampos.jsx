...
const EditarCampos = (informeId) => {
  const [editedReport, setEditedReport] = useState(informeId);
  ...
  const handleSave = () => {
    // Aquí puedes agregar la lógica para guardar el informe, por ejemplo, enviarlo a una API.
    console.log('Report saved:', editedReport);
  };
